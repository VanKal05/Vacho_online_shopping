...
class LVCA_Services
{
    ...
    public function shortcode_func( $atts, $content = null, $tag = "" )
    {
        ...
        $output = '<div id="lvca-services' . uniqid() . '" data-settings=\'' . htmlspecialchars( json_encode( $settings ) ) . '\' class="lvca-services lvca-' . esc_attr( $settings['style'] ) . ' lvca-grid-container ' . lvca_get_grid_classes( $settings ) . '">';
